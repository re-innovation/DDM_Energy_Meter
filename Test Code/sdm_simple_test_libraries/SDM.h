...
#include "SDM_Config_User.h"
  ...
  #include "SoftwareSerialParity.h" // ADDED
#endif
//------------------------------------------------------------------------------
...
class SDM {
  ...
  #else                                                                         //  on avr
    SDM(SoftwareSerialParity& serial, long baud = SDM_UART_BAUD, int dere_pin = DERE_PIN); // ADDED
  #endif
#endif
    virtual ~SDM();
...
#else
    SoftwareSerialParity& sdmSer; // ADDED
#endif
